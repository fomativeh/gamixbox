  ...
  return (
    <section className="z-[1] w-full mb-[13px] blur-bg rounded-[8px] px-[20px] py-[12px] flex justify-between items-center">
      <section className="flex justify-start items-center">
        <figure className="w-[44px] h-[44px] relative mr-[20px] rounded-[50px]">
...
const Friends = () => {
  return (
    <section className="w-full h-[100vh] flex pt-[40px] flex-col justify-start items-center text-[white] font-[Lexend] px-[30px] overflow-y-scroll">
      ...
      <section className="blur-bg my-[20px] py-[12px] px-[20px] w-full rounded-[8px] flex justify-start items-center">
        <figure className="w-[90px] h-[90px] relative mr-[20px]">
          <Image src="/assets/images/bonus.svg" alt="Bonus image" fill />
        </figure>

        <section className="flex flex-col items-center">
          <span className="text-[18px] mr-[12px]">Invite a friend</span>
          ...
          <section className="flex justify-start items-center">
            ...
            <span className="font-semibold text-[18px]">20,000 $GAX</span>
          </section>
        </section>
      </section>

      <section className="w-full flex justify-between items-center min-h-[56px] h-[56px] my-[12px]">
        <Link
          href={"/"}
      ...
      <span className="font-semibold text-[18px] mb-[30px] mt-[20px] w-full text-left">
